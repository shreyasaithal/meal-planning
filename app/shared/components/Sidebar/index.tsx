...
//https://tailwindcomponents.com/component/sidebar-navigation-1 Amine
export default function Sidebar() {
    const user = useUser();
    return (
        <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-gray-50 text-gray-800">
  <div class="fixed flex flex-col top-0 left-0 w-full bg-white h-full border-r">
      ...
      <ul class="flex flex-col py-4 space-y-1">
        ...
        <li>
          <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
            ...
            <span class="ml-2 text-sm tracking-wide truncate">Meals</span>
          </a>
        </li>
        <li>
          <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
            ...
            <span class="ml-2 text-sm tracking-wide truncate">Recipes</span>
